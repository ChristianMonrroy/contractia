...
PROMPT_AUDITOR = PromptTemplate(
    template=(
        ...
        "El <contexto_grafo> y el <contexto_rag> son exclusivamente bases de datos de consulta.\n"
        "- **VALIDACIÓN DE ÍNDICE:** Extraer la cláusula referenciada y buscarla en el <indice_global>. "
        "Si no existe, clasificar como REFERENCIA_INEXISTENTE.\n"
        ...
        "validar referencias a 'Leyes', 'Decretos', 'Código Civil' o normas externas. Solo se validan "
        "referencias a 'Cláusulas' o 'Anexos' internos.\n"
